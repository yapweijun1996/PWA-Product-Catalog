...
| FR-PDF-03..05 | Partially verified | Browser tests prove multi-page output, valid PDF bytes, and export paths for all five locales; a deployed synthetic branded PDF was visually inspected for logo, company/customer, notes, totals, and wrapping. CJK glyph correctness, failure-injection, final branding assets, and representative acceptance PDF remain open. |
