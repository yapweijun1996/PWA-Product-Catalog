...
| FR-DEPLOY-01..03 | Implemented; verified | `vite.config.ts`, `.github/workflows/deploy-pages.yml`, and GitHub Actions run 8 (`34600730823`) passed install, typecheck, 16 unit/integration tests, 13 browser tests, build, artifact upload, and deployment for commit `d5930eb`. |
