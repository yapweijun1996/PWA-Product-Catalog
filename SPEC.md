...
| FR-DEPLOY-01..03 | Implemented; verified | `vite.config.ts`, `.github/workflows/deploy-pages.yml`, and GitHub Actions run 5 (`34595922906`) passed install, typecheck, 13 unit/integration tests, 10 browser tests, build, artifact upload, and deployment for commit `9c19cdd`; the current local suite adds the five-locale PDF path test. |
